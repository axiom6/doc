...
Learning::    Leverage change to adopt new strategies.
              Embrace change to Adapt to, Discover and Govern new strategies.
...
Connection:: Chance favors the connected mind with serendipitous discoveries.
             Lots of connections as illustrated by the color coded rectangles.
Ecosystem::  Allows ideas to flow diffused and interact in novel ways.
Adjacent::   Adjacency allows possibilities emerge and become connected.
