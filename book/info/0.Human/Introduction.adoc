...
<<<
== [.black]#Three Columns with 12 Concerns#
=== [.black]#Embrace#
image::humanistic/Embrace.png[alt="Embrace",align="center"]

A tactical approach for human colaboration and adapting to change.
...
An innovative product definition, technology and delivery lifecycle.
...
A shared strategic vision for discovery, benefits and govern
...
image::humanistic/InfoPrac.png[alt="Info",align="center"]
