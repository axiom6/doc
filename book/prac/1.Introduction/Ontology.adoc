...
As of March 17, 2017 there are 27 million people with 57 open source repositories on GitHub.
...
* The subsequent document describes each of the nine practices.
